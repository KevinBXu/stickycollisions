    ...
    for L in Ls:
        ...
        for E in Es:
            ...
            if plot:
                ...
                plt.plot(after, np.abs(guess), color='brown', marker='x', markevery=10)
                plt.plot(before, np.abs(bpsi2), color='red')
                plt.plot(after, np.abs(apsi2), color='blue')
